      ...
      <main className="w-full py-6 px-4 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {stores.map((store) => (
              <div key={store.id} className="bg-slate-900/70 border border-slate-700/60 overflow-hidden shadow-xl rounded-xl">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-slate-400">{store.city || 'Cidade não informada'}</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <span className="text-sm text-slate-400">{store.plan}</span>
                  </div>
                </div>
              </div>
            ))}
